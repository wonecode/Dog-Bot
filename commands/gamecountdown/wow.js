...
module.exports = class wowCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: 'Compte à rebours avant que World of Warcraft soit finito pepito',
    });
  }
  ...
  async run(message) {
    ...
    var embed = new MessageEmbed()
      ...
      .setURL('https://www.newworld.com/fr-fr/game-editions')
      .setColor('GREEN')
      .addField(
        'Temps restant avant la fin de World of Warcraft',
        days + ' jours, ' + hours + ' heures, ' + minutes + ' minutes.'
      )
      .setImage('https://www.gamereactor.fr/media/06/_2940673b.jpg')
      .setFooter('');
